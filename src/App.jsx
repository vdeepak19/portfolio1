    ...
    <div className="app">
        ...
        <div className="container hero-container">
          <div className="hero-content">
            ...
            <div className="hero-social">
              ...
              <a href="mailto:v.d@live.in">Email</a>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="certifications-grid">
            ...
            <div className="certification-card">
              ...
              <div className="certification-content">
                <h3>MongoDB Certified Associate Developer</h3>
                <p>MongoDB</p>
              </div>
            </div>
        ...
        <div className="container contact-container">
          ...
          <div className="contact-card">
            ...
            <div className="contact-item">
              ...
              <p>KL University, Vijayawada, Andhra Pradesh, India</p>
            </div>

            <a href="mailto:v.d@live.in" className="contact-button">
              Send Message
            </a>
          </div>
        </div>
      ...
      <footer className="footer">
        <div className="container footer-container">
          <p>
            © {new Date().getFullYear()} Dr. Deepak V. All rights reserved.
          </p>
